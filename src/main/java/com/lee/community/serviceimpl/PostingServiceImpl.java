...
public class PostingServiceImpl implements PostingService {
    ...
    public int addPosting(Posting posting) {
        posting.setPostId("700"+String.valueOf(new Date().getTime()));
        posting.setPostTime(new Timestamp(new Date().getTime()));
    ...
    public int addComment(PostComment postComment) {
        postComment.setComTime(new Timestamp(new Date().getTime()));
