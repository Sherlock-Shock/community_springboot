...
public class PayMentServiceImpl implements PayMentService {
    ...
    public int addPayItem(PayItem payItem) {
        payItem.setPayItemId("300"+String.valueOf(new Date().getTime()));
    ...
    public int addPaymentList(PaymentList paymentList) {
        paymentList.setPaymentId("500"+String.valueOf(new Date().getTime()));
        return paymentListMapper.addPaymentList(paymentList);
    }

    @Override
    public List<Map> queryPaymentList(String payItemName,String beginTime,String overTime,String isPay,String paymentId) {
        return paymentListMapper.queryPaymentList(payItemName,beginTime,overTime,isPay,paymentId);
    }
    ...
    public int updatePaymentListToPay(PaymentList paymentList) {
        paymentList.setPayTime(new Timestamp(new Date().getTime()));
    ...
    public int addParkingPaymentList(ParkingTPayList parkingTPayList) {
        parkingTPayList.setPaymentId("550"+String.valueOf(new Date().getTime()));
        parkingTPayList.setPayTime(new Timestamp(new Date().getTime()));
    ...
    public int addPiLiangPaymentList(String payItemId, String charStandard, String charOnce) {
        ...
        for (Map item : charList){
            ...
            payOne.setPaymentId("500"+String.valueOf(new Date().getTime()));
